                            ...
                            <div class="job-sidebar-box">
                                <form>
                                    <select class="sidebar-category-select" name="states[]" multiple="multiple">
                                        ...
                                        <option value="7">After Effects</option>
                            ...
                            <div class="job-sidebar-box">
                                <form>
                                    <select class="sidebar-category-select-2" name="states[]">
                                        ...
                                        <option value="7">Nhà hàng / Thực phẩm</option>
                                ...
                                <div class="sigle-top-job">
                                    <div class="top-job-company-image">
                                        <div class="company-logo-img">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/company-logo-4.png') }}"
                                                    alt="logo công ty" />
                                            </a>
                                        </div>
                                    ...
                                    <div class="top-job-company-desc">
                                        <ul>
                                            <li>Địa điểm <span class="company-state"><i class="fa fa-map-marker"></i>
                                                    Brisbane</span></li>
                                            <li>Mức lương <span class="open-icon"><i
                                                        class="fa fa-credit-card-alt"></i>$600-$1200</span></li>
                                            <li>Trạng thái <span class="varify"><i class="fa fa-check"></i>Bán thời
                                                    gian</span>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="sigle-top-job">
                                    <div class="top-job-company-image">
                                        <div class="company-logo-img">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/company-logo-2.png') }}"
                                                    alt="logo công ty" />
                                            </a>
                                        </div>
                                        <h3><a href="#">Kỹ sư dân dụng có chứng chỉ</a></h3>
                                    </div>
                                    <div class="top-job-company-desc">
                                        <ul>
                                            <li>Địa điểm <span class="company-state"><i class="fa fa-map-marker"></i>
