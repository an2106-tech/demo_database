                  ...
                  <div class="col-md-12">
                     <div class="breadcromb-box-pagin">
                        <ul>
                           ...
                           <li class="active-breadcromb"><a href="#">Tin nhắn</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-3 col-md-4  mx-auto dashboard-left-border">
                  <div class="dashboard-left">
                     <ul class="dashboard-menu">
                        ...
                        <li class="active"><a href="message.html"><i class="fa fa-envelope-open"></i>Tin nhắn</a></li>
                        <li><a href="manage-jobs.html"><i class="fa fa-briefcase"></i>Quản lý việc làm</a></li>
                                       ...
                                       <ul class="chat-list">
                                          <li>
                                             ...
                                             <div class="chat-content">
                                                <div class="chat-text">
                                                   Đó là một cơ hội tuyệt vời để làm việc.
                                                </div>
                                          ...
                                          <li class="chat-list-right">
                                             <div class="chat-content">
                                                <div class="chat-text">
                                                   Đây chỉ là văn bản giả trong ngành in ấn và thiết kế.
                                                </div>
                                          ...
                                          <li>
                                             ...
                                             <div class="chat-content">
                                                <div class="chat-text">
                                                   Đã trở thành tiêu chuẩn của ngành.
                                                </div>
                                                <div class="chat-time">10:57 sáng</div>
                                             </div>
                                          </li>
                                          <li class="chat-list-right">
                                             <div class="chat-content">
                                                <div class="chat-text">
                                                   Cơ hội làm việc thật tuyệt vời.
                                                </div>
                                                <div class="chat-action">Đã xem</div>
                                             </div>
                                          </li>
