            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="available-count">
                     <h4>3087 jobs are available in <a href="#">programming & tech</a> category</h4>
                  </div>
               </div>
            </div>
            <div class="row">
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="sigle-top-job">
                     <div class="top-job-company-image">
                        <div class="company-logo-img">
                           <a href="#">
                           <img src="{{ asset('assets/img/company-logo-2.png') }}" alt="company image" />
                           </a>
                        </div>
                        <h3><a href="#">Certified civil engineer</a></h3>
                     </div>
                     <div class="top-job-company-desc">
                        <ul>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="sigle-top-job">
                     <div class="top-job-company-image">
                        <div class="company-logo-img">
                           <a href="#">
                           <img src="{{ asset('assets/img/company-logo-3.png') }}" alt="company image" />
                           </a>
                        </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="sigle-top-job">
                     <div class="top-job-company-image">
                        <div class="company-logo-img">
                           <a href="#">
                           <img src="{{ asset('assets/img/company-logo-1.png') }}" alt="company image" />
                           </a>
                        </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="sigle-top-job">
                     <div class="top-job-company-image">
                        ...
                        <h3><a href="#">Human Resources Consultant</a></h3>
                     </div>
                     <div class="top-job-company-desc">
                        <ul>
                           <li>Location <span class="company-state"><i class="fa fa-map-marker"></i> Brisbane</span></li>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="sigle-top-job">
                     <div class="top-job-company-image">
                        ...
                        <h3><a href="#">Event Support Specialist</a></h3>
                     </div>
                     <div class="top-job-company-desc">
                        <ul>
                           <li>Location <span class="company-state"><i class="fa fa-map-marker"></i> Brisbane</span></li>
